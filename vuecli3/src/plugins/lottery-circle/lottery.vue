...
export default {
	...
	computed:{
		difference(){
			...
			return (this.prizeNo / this.prizeNum) * 360 - 360 / this.prizeNum;
		},
		// prizeNo(){
	...
	methods:{
		...
		clickLottery(){
			...
			// this.flag = false;
			// this.startRotate();
			this.$emit('lotteryClick','lottryBtnOnClick')
		},
		startRotate(){
			var self = this;
			// var difference = (this.prizeCount / this.prizeNum) * 360 - 360 / this.prizeNum / 2;
