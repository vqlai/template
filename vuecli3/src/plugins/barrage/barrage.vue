<template>
  <div class="barrage-stage" v-show="isShow" ref="stage">
    <div class="barrage-top">
      <div v-for="item in topQueue" v-bind:style="item.style" v-bind:key="item.id" class="barrage-item" v-bind:class="item.barrageStyle">
        <div class="barrage-avatar"><img :src="item.avatar"></div>
        <div class="barrage-msg">{{ item.msg }}</div>
      </div>
    </div>
    <div v-for="item in barrageList" v-bind:style="item.style" v-bind:key="item.id"  class="barrage-item" v-bind:class="item.barrageStyle">
      <div class="barrage-avatar"><img :src="item.avatar"></div>
      <div class="barrage-msg">{{ item.msg }}</div>
    </div>
    <div class="barrage-bottom">
      <div v-for="item in bottomQueue" v-bind:key="item.id" v-bind:style="item.style" class="barrage-item" v-bind:class="item.barrageStyle">
        <div class="barrage-avatar"><img :src="item.avatar"></div>
        <div class="barrage-msg">{{ item.msg }}</div>
      </div>
    </div>
