<template>
    <div class="lottery">
        <ul>
            ...
            <li class="row">
              <div :class="[{active : activeClass[5-index]}]" v-for="(prize,index) in lis2" :key="index">
                <img :src="prize">
              </div>
            </li>
            <li class="row">
  ...
  export default {
    ...
    data() {
      return {
        ...
        activeClass: [false, false, false, false, false, false],
        index: -1,
        count: 6,
        timer: null,
        times: 0,
    ...
    props: {
      ...
      computed: {
        ...
        lis2() {
          return this.prizesList.slice(3, 6).reverse();
        }
      },
      created() {
        ...
        roll() {
          ...
          if (this.times > this.cycle + 10 && this.prize == this.index) {
            ...
            if (this.times < this.cycle) {
              ...
              if (this.times > this.cycle + 10 && ((this.prize == 0 && this.index == 5) || this.prize == this.index + 1)) {
                this.speedData += 110;
              } else {
                this.speedData += 20;
              }
