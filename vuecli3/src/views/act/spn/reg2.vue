<template>
  <div class="register">
    <div class="top">
      <img src="@/common/imgs/act/spn/register-bg2.jpg" alt="">
    </div>
    <div class="center">
    ...
    <a-dialog :isShowDialog="isDialog" :dialogType="1" :showCloseBtn="2"
      ...
      <div class="dialog">
        <div class="success" v-if="dialogType === 1">
          ...
          <van-button block class="btn" @click="wgDownload">点击下载APP 赢更多惊喜</van-button>
        </div> 
...
<script>
  ...
  import {getMsgCode,directRegister} from '@/api/act/spn.js'
  import aDialog from "@/components/a-dialog.vue"
  import {downloadApp} from '@/common/js/utils.js' 
  export default {
    name: 'register3', // wg wap端推广注册2
    data() {
      return {
        phone: '',
        code: '',
    ...
    methods: {
      wgDownload(){
        location.href = 'https://lnk0.com/easylink/ELYxpcA9'
      },
      onDownload(){
        downloadApp()
      },
